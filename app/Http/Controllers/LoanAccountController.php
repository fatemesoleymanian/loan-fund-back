...
class LoanAccountController extends Controller
{
    ...
    public function createPaidLoanAndWithoutPartition(Request $request){
            ...
            'no_of_paid_inst' => $request->number_of_installments,
        ]);
    ...
    public function createLoanAndPartition(LoanAndPartitionRequest $request){
        ...
        try {
            ...
            return response()->json([
                ...
                'msg' => $sms1 != null ?'با موفقیت اعطا شد. پیامک ارسال شد.':'با موفقیت اعطا شد',
                'success' => true,
                'sms' => $sms1,
                'sms2' => $sms2
            ]);
